...
main () {
    ...
    data_list=$(ls $path_in) # Sig or non-sig
            ...
            then
                ...
                do
                    ...
                    do
                        ...
                        projects_path=$path_in/$data/$species
                            ...
                            do
                                ...
                                then
                                    ...
                                    then
                                        ...
                                        echo $species","$out_name","$num_miRNAs >> $path_out_summary
                                        
                                        
                                    else
                                        printf "NOTE: $out_name""dea_"$suffix".fasta does not exist\n"
                                        echo $species","$out_name",0" >> $path_out_summary
                                    fi
                ...
                LANG=en_EN join -1 2 -2 2 -t ',' \
                        ...
                        $path_out/miRNA_identification_$suffix/hairpin/summary"_sort.csv"  > $path_out/miRNA_identification_$suffix/summary.csv
                sed -i '1 i\species,Experiment,Annot_miRNAs,Annot_precursor' $path_out/miRNA_identification_$suffix/summary.csv
